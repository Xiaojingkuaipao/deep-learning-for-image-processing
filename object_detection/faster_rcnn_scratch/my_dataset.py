...
class VOCDataSet(Dataset):
    ...
    def __init__(self, voc_root:str,year="2012", transforms=None,
        ...
        print(f"Checking path: {os.path.abspath(txt_path)}")
...
if __name__ == '__main__':
    ...
    root_dir = os.path.abspath(os.path.join(script_dir, "..", "faster_rcnn"))
    train_data_set = VOCDataSet(root_dir, "2012", data_transform["train"], "train.txt")
